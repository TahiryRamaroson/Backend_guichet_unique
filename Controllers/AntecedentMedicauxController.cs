...
namespace Backend_guichet_unique.Controllers
{
    ...
    public class AntecedentMedicauxController : ControllerBase
    {
		...
		[HttpPost("import/csv")]
		public async Task<ActionResult> ImportAntecedentMedicauxCSV(ImportDTO import)
		{
		...
		public async Task<ActionResult> ImportAntecedentMedicauxExcel(ImportDTO import)
		{
