...
namespace Backend_guichet_unique.Controllers
{
    ...
    public class CauseDecesController : ControllerBase
    {
		...
		public CauseDecesController(GuichetUniqueContext context, IMapper mapper)
        {
            _context = context;
			_mapper = mapper;
		}
		...
		[HttpPost("import/csv")]
		public async Task<ActionResult> ImportCauseDecesCSV(IFormFile file)
		{
		...
		public async Task<ActionResult> ImportCauseDecesExcel(IFormFile file)
		{
